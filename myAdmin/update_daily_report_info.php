                        ...
                        <?php  foreach($result as $row)  {
                           ...
                           if ($row["duepaid"] == 'due'){
                            ...
                            $due = 0;
                                                 ...
                                                 ?>
                            <form method="post" action="update_daily_report.php">
                                  ...
                                  <div class="form-group">
                                    <label>Total:</label>
                                    <input type="number" class="form-control" id="total" required placeholder="Total" name="total" value=<?php echo $total; ?>>
                                  </div>
                                  <div class="form-group">
                                    <label>Due:</label>
                                    <input type="number" class="form-control" id="due" required placeholder="Due" name="due" value=<?php echo $due; ?>>
                                  </div>
